...
// To use ejs-mate engine for  layout
    ...
    helmet.contentSecurityPolicy({
        directives: {
            ...
            imgSrc: [
                ...
                "blob:",
                "data:",
                "https://res.cloudinary.com/dxvki9bpw/", //SHOULD MATCH YOUR CLOUDINARY ACCOUNT! 
...
const secret = process.env.SECRET || 'thisshouldbeabtterscret'

const store = MongoStore.create({  // change this line
...
// session should be used before passport
